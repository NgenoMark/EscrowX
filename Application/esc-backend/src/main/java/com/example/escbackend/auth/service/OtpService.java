...
public class OtpService {
    ...
    public String generate(String identifier, String purpose) {
        String code = String.format("%06d", random.nextInt(1_000_000));
        store.put(identifier + ":" + purpose, new OtpRecord(code, OffsetDateTime.now().plusMinutes(10)));
        return code;
    }

    public void verify(String identifier, String purpose, String otp) {
        OtpRecord record = store.get(identifier + ":" + purpose);
        ...
        store.remove(identifier + ":" + purpose);
    }
